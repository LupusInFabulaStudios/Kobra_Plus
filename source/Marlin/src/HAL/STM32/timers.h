...
#define ENABLE_STEPPER_DRIVER_INTERRUPT() timer_enable_irq(STEP_TIMER_NUM,Enable)
#define DISABLE_STEPPER_DRIVER_INTERRUPT() timer_enable_irq(STEP_TIMER_NUM,Disable)
#define STEPPER_ISR_ENABLED() HAL_timer_interrupt_enabled(STEP_TIMER_NUM)

#define ENABLE_TEMPERATURE_INTERRUPT() timer_enable_irq(TEMP_TIMER_NUM,Enable)
#define DISABLE_TEMPERATURE_INTERRUPT() timer_enable_irq(TEMP_TIMER_NUM,Disable)
